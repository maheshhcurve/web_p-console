...
<form method="POST" style="display: flex;justify-content: center;top:20px;">
    ...
    <div class="input-box" style="display: flex; align-items: center;top: -85px;position: absolute;left: 440px">
     ...
     <select name="template" id="templte" style="border:2px solid #24b2be;border-radius:3px;height:39px;flex: 1;" class="templte" >
   ...
   <select name="clients" id="clients" style="border:2px solid #24b2be;border-radius:3px;height:39px;flex: 1;" class="clients" >
